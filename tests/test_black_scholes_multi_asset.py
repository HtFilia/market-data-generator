...
def test_multi_asset_same_sector_same_area():
    ...
    assert len(model._model_data.volatility) == 3
...
def test_multi_asset_all_different():
    ...
    assert len(model._model_data.volatility) == 4
